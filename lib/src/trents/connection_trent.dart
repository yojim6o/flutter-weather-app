...
class ConnectionTrent extends Trent<ConnectionStatus> {
  ...
  void _startListening() async {
    ...
    debugPrint("ConnectionTrent: just before listening");

    _subscription = Rx.combineLatest2<
      ServiceStatus,
      List<ConnectivityResult>,
      ConnectionStatus
    >(Geolocator.getServiceStatusStream(), connectivity.onConnectivityChanged, (
      ServiceStatus location,
      List<ConnectivityResult> internet,
    ) {
      debugPrint('$location, $internet');
    ...
    debugPrint("ConnectionTrent: just after listening");
  }
}
